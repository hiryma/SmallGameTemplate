...
namespace Kayac
{
		...
		, IDragHandler
	{
		...
		static Rect GetSafeArea() // 上書き用
		{
			var settings = ScreenSettings.Instance;
			return settings.SafeArea;
		}
		...
		void UpdateTransform()
		{
			...
			var screenWidth = (float)ScreenSettings.Instance.Width;
			var screenHeight = (float)ScreenSettings.Instance.Height;
